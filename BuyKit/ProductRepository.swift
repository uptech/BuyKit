...
public protocol ProductRepositoryObserver {
    func updated(products: [SKProduct], invalidProductIdentifiers: [String])
...
extension ProductRepository: SKProductsRequestDelegate {
    public func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
        ...
        self.observers.forEach({ $0.value?.updated(products: products, invalidProductIdentifiers: response.invalidProductIdentifiers) })
        clearRequest()
    }
